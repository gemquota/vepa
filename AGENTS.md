...
| **HEAD** | `0f2348a` — `chore(release): v8.16.0 — Set P "Synthetic Life" (synthetic organisms / uploaded consciousness / machine groups) + per-law profiling + main-thread lag fixes` (tagged `v8.16.0`) |
