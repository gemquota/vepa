import { A as DOMAdapter, M as InstructionSet, N as multiplyHexColors, P as BigPool, Q as v8_0_0, R as warn, V as Texture, Z as deprecation, dt as extensions, it as Matrix, rt as groupD8, s as RendererType, ut as ExtensionType, z as Color } from "./Geometry-DNPQ-Kix.js";
import { c as ViewContainer, n as State, o as CanvasSource, w as bgr2rgb } from "./Filter-DWP60dGf.js";
import { A as SpritePipe, I as AlphaMaskPipe, L as BatcherPipe, N as CustomRenderPipe, Y as AbstractRenderer, a as SharedSystems, j as RenderGroupPipe, k as BlendModePipe, t as RenderTargetSystem, z as color32BitToUniform } from "./RenderTargetSystem-BK03943E.js";
import { t as GCManagedHash } from "./GCManagedHash-CkTA9p3I.js";
import { A as shapeBuilders, G as BatchableGraphics, M as FillGradient, O as GraphicsContextSystem, R as buildLine, a as FillPattern, j as generateTextureMatrix, t as GraphicsContext } from "./GraphicsContext-DNmVBR--.js";
...
function buildStrokeMaskPath(context, shape, strokeStyle) {
	...
	const vertices = [];
	const indices = [];
	if (!shapeBuilders[shape.type]?.build(shape, points)) return false;
	buildLine(points, strokeStyle, false, shape.closePath ?? true, vertices, indices);
	...
	execute(instruction) {
		...
		for (let i = 0; i < instructions.length; i++) {
			...
			for (let j = 0; j < shapePrimitives.length; j++) {
				...
				if (isStroke && data.style) drewPath = buildStrokeMaskPath(context, primitive.shape, data.style) || drewPath;
				else {
...
//#endregion
export { CanvasGraphicsAdaptor as a, mapCanvasBlendModesToPixi as c, CanvasBatchAdaptor as d, Graphics as f, CanvasGraphicsContextSystem as g, CanvasGraphicsPipe as h, CanvasRenderTargetAdaptor as i, CanvasStencilMaskPipe as l, GraphicsPipe as m, CanvasTextureSystem as n, CanvasLimitsSystem as o, GraphicsGpuData as p, CanvasRenderTargetSystem as r, CanvasContextSystem as s, CanvasRenderer as t, CanvasColorMaskPipe as u };

//# sourceMappingURL=CanvasRenderer-Dkt_5YRL.js.map