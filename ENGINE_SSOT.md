...
*   **glow:** Enables visual signaling pulses and state-propagation.
*   **affinity:** Toggles species-specific attraction/repulsion bias.
*   **reproduction:** Toggles spontaneous spawning (Birth Rate).
*   **senescence:** Toggles aging-related population decay (Death Rate).
*   **tracking:** Enables predator/prey and signal-response vectors.
*   **genotype:** Toggles DNA inheritance and mutation.
*   **phenotype:** Toggles physical/visual expression of DNA (Alpha, Shape).

### [Chemistry Laws]
*   **cata:** Catalysis; speeds up localized reactions and state changes.
*   **solv:** Solvation; dissolves molecular bonds over time.
*   **acid:** Acidity; direct mass degradation on contact.
*   **oxid:** Oxidation; exothermic energy release on collision.
*   **redu:** Reduction; endothermic mass accumulation.
*   **poly:** Polymerization; forces linear bonding/chaining.
*   **isom:** Isomerization; spontaneous species identity shifts.
*   **chir:** Chirality; spin-based bonding compatibility.
*   **crys:** Crystallization; forces rigid geometric lattices.
*   **allo:** Allotropy; phase shifting between identical species.

### [Thermodynamics Laws]
*   **heat:** Global kinetic energy injection (thermal noise).
*   **cold:** Global velocity dampening (thermal sink).
*   **conv:** Convection; creates cyclic vertical flow loops based on heat.
*   **radi:** Radiation; high-energy particles push others away/lose mass.
*   **subl:** Sublimation; instant solid-to-gas phase dispersion.
*   **melt:** Melting; bond degradation in high-energy/density zones.
*   **boil:** Boiling; explosive volume expansion at energy thresholds.
*   **cond:** Condensation; increased attraction in low-energy zones.
*   **depo:** Deposition; instant gas-to-solid phase transition.
*   **exop:** Exothermic; systemic heat release during interactions.

### [Metaphysics Laws]
*   **time:** Time Dilation; local physics step ($dt$) variance.
*   **dime:** Dimensionality; allows phasing through spatial collisions.
*   **chao:** Chaos Factor; non-linear vector injection.
*   **orde:** Total Order; forces absolute grid/coordinate alignment.
*   **fate:** Determinism; locks particles into fixed trajectories.
*   **will:** Free Will; spontaneous vector negation/reversal.
*   **soul:** Persistence; identity data retention across death cycles.
*   **mind:** Hive Mind; global telepathic state synchronization.
*   **tele:** Teleportation; instant relocation at boundaries.
*   **clai:** Clairvoyance; proactive collision avoidance.
*   **preo:** Precognition; proactive evasion of high-density zones.
*   **astr:** Astral Projection; remote interaction via ghost forms.
