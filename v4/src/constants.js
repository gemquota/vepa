...
export const LAW_HELP_DB = {
  ...
  SYMBOL: {
    ...
    explanation: "Confirmed batch-18: same-species particles attract by SPECIES_AFFINITY DNA; different species feel the opposite bias at half strength.",
    system: "F = k·affinity/(dist+1), cross-species affinity ×−0.5. +LEARN ×1.4 species schooling. Positive affinity = gregarious swarms, negative = territorial dispersal.",
  },
  METRIC: {
